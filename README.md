# Hugo Future Imperfect Lawliet

**Hugo Future Imperfect** *Lawliet* is a theme based on [pacollins's](https://github.com/pacollins)
port of [HTML5 UP's theme](http://html5up.net/future-imperfect-slim) by the same name.
...
- [Hugo Future Imperfect Lawliet](#hugo-future-imperfect-lawliet)
